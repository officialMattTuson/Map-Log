...
export class MapOverlayComponent {
  ...
  @ViewChild(MapOverlayDirective, {static: true}) mapOverlayDirective: MapOverlayDirective;
  ...
  createMapOverlayComponent(overlayComponent: Type<MapDrawerComponent>) {
    ...
    this.mapOverlayComponentRef = containerRef.createComponent<MapDrawerComponent>(overlayComponent);
